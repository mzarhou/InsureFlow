...
function instance($$self, $$props, $$invalidate) {
  ...
  (0,svelte_internal__WEBPACK_IMPORTED_MODULE_1__.component_subscribe)($$self, _store__WEBPACK_IMPORTED_MODULE_2__.default, function ($$value) {
    return $$invalidate(4, $store = $$value);
  });
  ...
  $$self.$$.update = function () {
    ...
    /*$store*/
    16) {
      $: $$invalidate(5, layout = $store.component && $store.component.layout);
    }
  ...
  return [components, initialPage, resolveComponent, child, $store, layout];
}
...
/******/ 			return "js/" + chunkId + ".js?id=" + "55e9b9422054a7a70f73" + "";
/******/ 		};
/******/ 	})();
/******/ 	

<script>
    ...
    onMount(async () => {
        new Chart(document.getElementById('buyers-chart'), buyersData)
        new Chart(document.getElementById('reviews-chart'), reviewsData)
    });
  </script>
...
<div id="home">
    <!-- breadcrumb -->
        ...
        <div class="items-center justify-between mb-6 lg:flex">
          <p class="mb-2 text-2xl font-semibold lg:mb-0">Good afternoon, Joe!</p>
        ...
        <div class="flex flex-wrap -mx-3">
          ...
          <div class="w-full px-3 xl:w-1/3">
            ...
            <div class="w-full p-4 bg-white border rounded-lg">
              <div class="flex items-center justify-between w-full px-4 py-2 mb-4 bg-gray-100 border rounded-lg">
                  <div>
              ...
              <div class="flex items-center justify-between w-full px-4 py-2 bg-gray-100 border rounded-lg">
                  <div>

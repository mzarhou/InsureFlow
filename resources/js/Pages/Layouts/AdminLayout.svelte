        ...
        <div class="flex flex-col bg-white sm:flex-row sm:justify-around">
            ...
            <div class="h-screen w-72">
                ...
                <nav class="px-6 mt-10 ">
                    ...
                    <a href={route("gestion-clients.index")} use:inertia class="{route().current('gestion-clients.*') ? 'bg-gray-100 text-gray-800' : 'text-gray-600'} flex items-center p-2 my-6transition-colors duration-200 rounded-lg hover:text-gray-800 hover:bg-gray-100">
                    ...
                    <a use:inertia href={route("gestion-charges.index")} class="{route().current('gestion-charges.*') ? 'bg-gray-100 text-gray-800' : 'text-gray-600'} flex items-center p-2 my-6 transition-colors duration-200 rounded-lg hover:text-gray-800 hover:bg-gray-100">

        ...
        <div class="flex flex-col bg-white sm:flex-row sm:justify-around">
            ...
            <div class="h-screen w-72">
                ...
                <nav class="px-6 mt-10 ">
                    <a href={route("index")} use:inertia class:bg-gray-100={route()?.current("index")} class="flex items-center p-2 my-6 text-gray-600 transition-colors duration-200 rounded-lg hover:text-gray-800 hover:bg-gray-100">
                    ...
                    <a href={route("gestion-client.index")} use:inertia class:bg-gray-100={route().current("gestion-client.*")} class="flex items-center p-2 my-6 text-gray-800 transition-colors duration-200 rounded-lg hover:text-gray-800 hover:bg-gray-100">
                    ...
                    <a use:inertia class:bg-gray-100={isUrl('todo-test')}  href="" class="flex items-center p-2 my-6 text-gray-600 transition-colors duration-200 rounded-lg hover:text-gray-800 hover:bg-gray-100">
                        ...
                        <span class="flex-grow text-right">
                            <button type="button" class="w-6 h-6 text-xs text-white bg-red-500 rounded-full">
                                <span class="p-1">
                                    7
                                </span>
                            </button>

        ...
        <div class="flex flex-col bg-white sm:flex-row sm:justify-around">
            ...
            <div class="h-screen w-72">
                ...
                <nav class="px-6 mt-10 ">
                    ...
                    <a href={route("gestion-clients.index")} use:inertia class:bg-gray-100={route().current("gestion-clients.*")} class="flex items-center p-2 my-6 text-gray-800 transition-colors duration-200 rounded-lg hover:text-gray-800 hover:bg-gray-100">
                    ...
                    <a use:inertia class:bg-gray-100={route().current("gestion-charges.*")}  href={route("gestion-charges.index")} class="flex items-center p-2 my-6 text-gray-600 transition-colors duration-200 rounded-lg hover:text-gray-800 hover:bg-gray-100">
